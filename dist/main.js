...
function buildTaskView(task) {
  ...
  checkbox.addEventListener("click", (e) => {
    ...
    } else _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish("taskUnchecked", task);
  });
  ...
  function buildExpandedTask(task) {
    ...
    del.value = "Delete";
    del.addEventListener("click", () => _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish("taskDeleted", task));
...
const storeTask = (() => {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe("taskChecked", modify);
  return { tasks, store };
})();
...
(function ViewController() {
  ...
  const task3 = (0,_task__WEBPACK_IMPORTED_MODULE_0__.Task)("task2", "test", "2021-09-23", "!!!", "project2");
