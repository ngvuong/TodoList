...
/* harmony export */   "buildExpandedTaskView": () => (/* binding */ buildExpandedTaskView)
/* harmony export */ });
...
function todayView() {
  ...
  for (const task of _storage__WEBPACK_IMPORTED_MODULE_1__.storeTask.tasks) {
    (0,_buildTask__WEBPACK_IMPORTED_MODULE_2__.buildTaskView)(task);
  }
