...
function tasksView() {
  const dates = [...new Set(_storage__WEBPACK_IMPORTED_MODULE_0__.storeTask.tasks.map((task) => task.date))];
...
(function View() {
  ...
  form.addEventListener(
    ...
    function (e) {
      ...
      (0,_buildTask__WEBPACK_IMPORTED_MODULE_5__.buildTaskView)(task);
      toggleForm(formOverlay, container);
      form.reset();
    },
    true
