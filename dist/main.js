...
const todayView = (function () {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_3__.pubsub.subscribe("taskChecked", completeTask);
  _pubsub__WEBPACK_IMPORTED_MODULE_3__.pubsub.subscribe("taskUnchecked", addTask);
  _pubsub__WEBPACK_IMPORTED_MODULE_3__.pubsub.subscribe("taskDeleted", deleteTask);
  return { renderView, renderStats };
})();
