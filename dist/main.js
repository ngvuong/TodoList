...
const projectView = (function () {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe("taskAdded", updateView, renderStats);
  _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe("taskDeleted", deleteTask);
...
const tasksView = (function () {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_2__.pubsub.subscribe("taskAdded", updateView, addTask);
  _pubsub__WEBPACK_IMPORTED_MODULE_2__.pubsub.subscribe("taskChecked", completeTask);
  _pubsub__WEBPACK_IMPORTED_MODULE_2__.pubsub.subscribe("taskUnchecked", addTask);
  _pubsub__WEBPACK_IMPORTED_MODULE_2__.pubsub.subscribe("taskDeleted", deleteTask);
...
(function ViewController() {
  ...
  _storage__WEBPACK_IMPORTED_MODULE_4__.storeTask.store(task1, task2, task3);
  _storage__WEBPACK_IMPORTED_MODULE_4__.storeProject.store(task1.project, task2.project, task3.project);
