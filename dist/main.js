...
function todayView() {
  ...
  addTaskBtns.forEach((btn) =>
    btn.addEventListener("click", () => {
      form.date.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "yyyy-MM-dd");
      toggleForm(formOverlay, container);
...
(function View() {
  ...
  _storage__WEBPACK_IMPORTED_MODULE_3__.storeTask.store(task1, task2);
