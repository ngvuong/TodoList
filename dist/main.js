...
(function ViewController() {
  ...
  const task2 = (0,_task__WEBPACK_IMPORTED_MODULE_0__.Task)("task2", "test", "2021-09-15", "!!!", "Project2");
  ...
  function renderView() {
    ...
    if (page !== currentPage) {
      ...
      if (page === "Today") {
        ...
        _tasks_view__WEBPACK_IMPORTED_MODULE_2__.tasksView.renderView();
      } else if (page === "Week Ahead") {
        _week_view__WEBPACK_IMPORTED_MODULE_4__.weekView.renderView();
      } else _project_view__WEBPACK_IMPORTED_MODULE_3__.projectView.renderView();
    }
  }
})();
