...
function buildTaskView(task) {
  ...
  function buildExpandedTask(task) {
    ...
    const priorityLabels = formClone.querySelectorAll(".priority-radio");
    priorityLabels.forEach((div) =>
      div.addEventListener("change", function () {
        [...this.children].forEach((label) => {
          if (label.firstElementChild.checked) {
            label.style.backgroundColor = "blue";
          } else label.style.backgroundColor = "green";
        });
      })
    );
...
function projectView() {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe("taskAdded", () => {
...
function tasksView() {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_2__.pubsub.subscribe("taskAdded", () => {
    const currentPage = document.querySelector(".view h1");
...
function todayView() {
  ...
  for (const task of _storage__WEBPACK_IMPORTED_MODULE_1__.storeTask.tasks) {
    renderTask(task);
  }
  view.append(heading, taskList);

  _pubsub__WEBPACK_IMPORTED_MODULE_3__.pubsub.subscribe("taskAdded", renderTask);
  function renderTask(task) {
    if (task.date === today) {
...
(function ViewController() {
  ...
  const task3 = (0,_task__WEBPACK_IMPORTED_MODULE_0__.Task)("task2", "test", "2021-09-20", "!!!", "project2");
  ...
  (0,_today_view__WEBPACK_IMPORTED_MODULE_1__.todayView)();
  ...
  function renderView() {
    ...
    if (page !== currentPage) {
      ...
      if (page === "Today") {
        ...
        (0,_tasks_view__WEBPACK_IMPORTED_MODULE_2__.tasksView)();
      } else (0,_project_view__WEBPACK_IMPORTED_MODULE_3__.projectView)();
    }
  }
})();
