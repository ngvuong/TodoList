...
const todayView = (function () {
  ...
  function renderTask(task) {
    if (task.date === today) {
      taskList.append((0,_buildTask__WEBPACK_IMPORTED_MODULE_1__.buildTaskView)(task));
    }
  }
