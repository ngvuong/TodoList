...
function tasksView() {
  ...
  const tasks = _storage__WEBPACK_IMPORTED_MODULE_0__.storeTask.tasks.sort();
  const view = document.querySelector(".view");
  view.textContent = "";
...
(function View() {
  const view = document.querySelector(".view");
  const task1 = (0,_task__WEBPACK_IMPORTED_MODULE_0__.Task)("task1", "test", "2021-09-15", "!!!", "project1");
  const task2 = (0,_task__WEBPACK_IMPORTED_MODULE_0__.Task)("task2", "test", "2021-09-16", "!!!", "project1");
  _storage__WEBPACK_IMPORTED_MODULE_4__.storeTask.store(task1, task2);
