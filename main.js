...
function createTaskFromInput(form) {
  ...
  (0,_tasks_view__WEBPACK_IMPORTED_MODULE_1__.tasksView)();
  return task;
}
...
function todayView() {
  ...
  function buildExpandedTaskView(task) {
    ...
    console.log(task === _storage_js__WEBPACK_IMPORTED_MODULE_1__.storeTask.tasks[1]);
  ...
  function expandTask() {
    ...
    console.log(_storage_js__WEBPACK_IMPORTED_MODULE_1__.storeTask.tasks);
  }

  view.append(heading, btn);
  for (const task of _storage_js__WEBPACK_IMPORTED_MODULE_1__.storeTask.tasks) {
    buildTask(task);
  }
  const addTaskBtns = document.querySelectorAll(".task-btn");
  addTaskBtns.forEach((btn) =>
    btn.addEventListener("click", () => {
      form.date.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "yyyy-MM-dd");
      toggleForm(formOverlay, container);
