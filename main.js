...
function tasksView() {
  ...
  _pubsub__WEBPACK_IMPORTED_MODULE_2__.pubsub.subscribe("taskAdded", renderTask);
...
(function View() {
  ...
  const task2 = (0,_task__WEBPACK_IMPORTED_MODULE_0__.Task)("task2", "test", "2021-09-15", "!!!", "project1");
